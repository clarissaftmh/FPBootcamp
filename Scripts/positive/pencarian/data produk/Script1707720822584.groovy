...
//def rentangHarga = testData.getValue("rentangHarga", row)
...
WebUI.waitForElementVisible(findTestObject('Object Repository/data driven/card_result'), 5)
WebUI.click(findTestObject('Object Repository/data driven/card_result'))
